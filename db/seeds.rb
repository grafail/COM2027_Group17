...
Event.create!([
                ...
                { user_id: 1, name: "Test Event 2", description: "This is a description.", eventDate: "2020-12-26 18:00:00", location: "New York", latitude: 40.7127281, longitude: -74.0060152, eventType: 1 },
                { user_id: 1, name: "Test Event 3", description: "This is a description.", eventDate: "2020-12-27 18:00:00", location: "New York", latitude: 40.7127281, longitude: -74.0060152, eventType: 0 }
              ])
Ticket.create!([
